  ...
  return (
    <div className="min-h-screen flex items-center justify-center py-12 px-4 relative overflow-hidden bg-gradient-to-br from-slate-900 via-slate-900 to-slate-800">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-1/4 left-1/4 w-96 h-96 bg-cyan-500/20 rounded-full filter blur-3xl animate-pulse delay-1000" />
      ...
      <div className="max-w-5xl w-full relative z-10 flex flex-col lg:flex-row-reverse items-center gap-12">
        {/* Right Side - Branding */}
        <motion.div
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-4">
            {[
              { icon: Heart, label: 'Track Mood', color: 'from-rose-500 to-pink-600' },
              { icon: Brain, label: 'AI Coaching', color: 'from-cyan-500 to-blue-600' },
              { icon: Target, label: 'Set Goals', color: 'from-emerald-500 to-teal-600' },
              { icon: Sparkles, label: 'Meditate', color: 'from-violet-500 to-purple-600' },
            ].map((benefit, idx) => (
              <motion.div
                key={benefit.label}
              ...
              >
                <div className={`w-10 h-10 rounded-lg bg-gradient-to-br ${benefit.color} flex items-center justify-center mb-2`}>
        ...
        >
          <div className="bg-white/10 backdrop-blur-xl rounded-3xl p-8 border border-white/20 shadow-2xl shadow-cyan-500/10">
            <div className="text-center mb-6">
              ...
              <p className="text-white/60">Begin your wellness journey</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-3 bg-white/5 border border-white/20 rounded-xl text-white placeholder-white/40 focus:outline-none focus:border-cyan-400 focus:ring-2 focus:ring-cyan-400/20 transition-all"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-12 py-3 bg-white/5 border border-white/20 rounded-xl text-white placeholder-white/40 focus:outline-none focus:border-cyan-400 focus:ring-2 focus:ring-cyan-400/20 transition-all"
              ...
              <div>
                ...
                <div className="relative">
                  <CheckCircle className="absolute left-4 top-1/2 transform -translate-y-1/2 w-5 h-5 text-cyan-400" />
                  <input
              ...
              <label className="flex items-start gap-3 cursor-pointer group">
                <input
                  type="checkbox"
                  required
                  className="mt-1 w-4 h-4 rounded border-white/30 bg-white/5 text-cyan-400 focus:ring-cyan-400/20"
                />
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              className="w-full py-3 bg-white/5 border border-white/20 rounded-xl text-white font-medium hover:bg-white/10 transition-all flex items-center justify-center gap-3 disabled:opacity-50"
            >
