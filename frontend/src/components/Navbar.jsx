          ...
          <div className="p-6 border-b border-white/10">
            {currentUser ? (
              ...
              <div className="text-center">
                <p className="font-semibold text-white">Welcome to NeuroVerse</p>
            ...
            {currentUser ? (
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        ...
                        <ChevronRight className="ml-auto w-5 h-5 text-white/40" />
                      </Link>
                    </motion.div>
                  );
                })}
              ...
              <div className="px-6 space-y-3">
                <Link
                  to="/login"
                  onClick={() => setMobileMenuOpen(false)}
                  className="block w-full py-3 text-center text-white border border-white/10 rounded-xl hover:bg-white/10"
                >
                  Sign In
                </Link>
                ...
                <Link
                  to="/signup"
                  onClick={() => setMobileMenuOpen(false)}
                  className="block w-full py-3 text-center bg-gradient-to-r from-cyan-500 to-purple-600 text-white rounded-xl"
                >
                  Create Account
                </Link>
              </div>
          ...
          {currentUser && (
            <div className="p-4 border-t border-white/10 space-y-2">
              <Link
                to="/profile"
                onClick={() => setMobileMenuOpen(false)}
                className="flex items-center gap-3 px-4 py-3 rounded-xl text-white/70 hover:bg-white/10"
              >
              ...
              <button
                ...
                className="flex items-center gap-3 px-4 py-3 rounded-xl text-rose-400 hover:bg-rose-500/10 w-full"
              >
                <LogOut className="w-5 h-5" />
                <span>Sign Out</span>
              </button>
